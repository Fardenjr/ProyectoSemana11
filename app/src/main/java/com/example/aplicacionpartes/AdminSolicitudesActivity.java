...
public class AdminSolicitudesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin); // usa tu layout principal con recyclerSolicitudes
    ...
    private void cargarSolicitudes() {
        rootRef.child("solicitudes_admin").addValueEventListener(new ValueEventListener() {
            @Override
    ...
    private void enviarRespuestaAlUsuario(String uidDestino, String textoRespuesta) {
        ...
        Mensaje respuesta = new Mensaje(textoRespuesta, true);
